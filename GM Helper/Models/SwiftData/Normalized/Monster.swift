...
class Monster: Nameable {
    ...
    @Relationship(deleteRule: .cascade, inverse: \Abilities.monster) var abilities: Abilities?
    @Relationship(deleteRule: .cascade, inverse: \ActionTrait.monster) private var actionTraits: [ActionTrait]? = []
    @Relationship(deleteRule: .cascade, inverse: \Proficiency.monster) private var proficiencies: [Proficiency]? = []
