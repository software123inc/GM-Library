...
class Monster_WoTC: Decodable, Nameable, ImageSource {
    ...
    @Relationship(deleteRule: .cascade, inverse: \URL_WoTC.monsterWoTC) var conditionImmunities: [URL_WoTC]? = []
    ...
    @Relationship(deleteRule: .cascade, inverse: \Senses_WoTC.monsterWoTC) var senses:Senses_WoTC?
    @Relationship(deleteRule: .cascade, inverse: \SpecialAbility.monsterWoTC) var specialAbilities: [SpecialAbility]? = []
    @Relationship(deleteRule: .cascade, inverse: \Speed_WoTC.monsterWoTC) var speed:Speed_WoTC?
